...
function createGuessYouLike(data) {
    ...
    switch (n) {
        case 1:
            data['result'] = data.id % 2 === 0 ? '《Excuting Magic》' : '《Elements Of Roboties》'
            break
        case 2:
            data['result'] = data.id % 2 === 0 ? '《Improving Psychiatric Care》' : '《Programming Lauguages》'
            break
        case 3:
